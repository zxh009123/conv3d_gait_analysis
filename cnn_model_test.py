...
def cnn_model():
	...
	model = Sequential()
	#conv1
	model.add(Conv3D(16, (2,2,2), strides=(1, 1, 1), padding='valid',data_format = 'channels_last' , dilation_rate=(1, 1, 1), activation='relu', use_bias=True, kernel_initializer='glorot_uniform', bias_initializer='zeros', input_shape=(LAYER_HEIGHT, LAYER_WIDTH, LAYER_LENGTH, 1)))
